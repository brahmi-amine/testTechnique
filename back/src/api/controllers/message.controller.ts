...
export class MessageController {
    ...
    /**
     * The function saves a message and returns a response with the saved message or an error message.
     * @param {Request} req - The `req` parameter is an object representing the HTTP request 
     * @param {Response} res - The `res` parameter is an instance of the `Response` object
