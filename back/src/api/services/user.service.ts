...
export class UserService {
    ...
    /**
     * The function retrieves a user by their ID from the UserModel and returns a Promise that resolves to an IUser object or null.
     * @param {string} id - A string representing the unique identifier of the user.
